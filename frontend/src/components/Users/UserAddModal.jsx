    ...
    <>
      <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
        <div className="bg-white p-6 rounded w-96 max-h-[90%] overflow-auto relative">
          ...
          <input name="access_time_start" type="time" value={form.access_time_start} onChange={handleChange} maxLength={8} className="w-full border p-2 mb-2 rounded" />
          <input name="access_time_end" type="time" value={form.access_time_end} onChange={handleChange} maxLength={8} className="w-full border p-2 mb-2 rounded" />
          ...
          <button onClick={handleSubmit} className="bg-green-500 text-white px-4 py-2 rounded mt-4 w-full hover:bg-green-600">Save</button>
        </div>
      </div>
