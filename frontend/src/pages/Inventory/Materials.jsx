...
import { getMaterials, addMaterial, updateMaterial, deleteMaterial } from "../../services/materialsService";
                ...
                <table className="w-full text-sm text-center">
                    ...
                    <tbody>
                        {paginated.length ? paginated.map(i => (
                            ...
                            <tr>
                                <td colSpan="6" className="p-4 text-gray-500">No material records found</td>
                            </tr>
                        )}
                    </tbody>
                </table>
            ...
            {deleteData && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-6 rounded w-96">
                        <p>Delete <strong>{deleteData.material_name}</strong>?</p>
