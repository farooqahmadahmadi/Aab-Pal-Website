            ...
            {paginated.length ? (
              paginated.map((i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td>
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-semibold ${i.transaction_type === "Income" ? "bg-green-100 text-green-500" : "bg-red-100 text-red-500"}`}
                      >
                        {i.transaction_type}
                      </span>
                    </td>
              ...
              <tr>
                <td colSpan="6" className="p-4 text-gray-500">
                  No cash transaction records found
                </td>
              </tr>
            )}
          </tbody>
