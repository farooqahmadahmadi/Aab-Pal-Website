...
export default function TermsList() {
  ...
  const handleDelete = async () => {
    try {
      await deleteTerm(deleteItem.tc_id);
  ...
  return (
    <div className="p-3 sm:p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-3 mb-4">
        <h2 className="text-xl sm:text-2xl font-bold">Terms</h2>
        ...
        <div className="hidden md:block">
          <table className="w-full text-sm">
            ...
            <tbody>
              {paginated.length ? (
                paginated.map((i) => (
                  <tr key={i.tc_id} className="border-t text-center">
                    <td className="p-2">{i.tc_id}</td>
                    <td className="p-2">{i.tc_title}</td>
        ...
        <div className="md:hidden p-2 space-y-3">
          {paginated.length ? (
            paginated.map((i) => (
              ...
              >
                <CardRow label="Title" value={i.tc_title} />
